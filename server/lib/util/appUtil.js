...
exports.loadDefaultComponents = function(app){
	...
	var components = speedt.components;
	app.load(components.connection, app.get('connectionConfig'));
	app.load(components.connector, app.get('connectorConfig'));
	app.load(components.monitor, app.get('monitorConfig'));
	app.load(components.session, app.get('sessionConfig'));
};
