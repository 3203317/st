...
proto.start = function(cb){
	...
	switcher.on('connection', self.emit.bind(self, 'connection'));
	switcher.on('disconnect', self.emit.bind(self, 'disconnect'));
	switcher.on('handshake', genSocket.bind(self));
