...
proto.start = function(cb){
	...
	switcher = new Switcher(server, self.opts);
	switcher.on('listening', self.emit.bind(self, 'listening'));
	switcher.on('close', self.emit.bind(self, 'close'));
	switcher.on('error', self.emit.bind(self, 'error'));
	// TODO
