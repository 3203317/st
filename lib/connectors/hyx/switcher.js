...
var newSocket = function(socket){
	...
	// TODO
	self.emit('connection', socket.remoteAddress, onConnection.bind(self, socket, timeout, error));
};

var onConnection = function(socket, timeout, error, result){
	var self = this;
	if(!socket) return;
